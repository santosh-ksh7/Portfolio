  ...
  return (
        <div className="navbar">
            ...
            <div className="navbarlinks">
                ...
                <a target="_blank" rel="noreferrer" className="remdec" href="https://www.google.com/">Resume</a>
            ...
            >
                ...
                <DialogContentText id="alert-dialog-slide-description">
                  <div style={{display: "flex", flexDirection: "column", color: "black", textAlign: "center"}}>
                    ...
                    <a style={{textDecoration: "none"}} target="_blank" rel="noreferrer" href="https://www.google.com/">Resume</a>
