  ...
  return (
        <div className="navbar">
            ...
            <div className="navbarlinks">
                ...
                <a target="_blank" rel="noreferrer" className="remdec" href="https://drive.google.com/file/d/1ca2-CwJA19s8AIClKO-gbGWlA9SroAF1/view?usp=sharing">Resume</a>
            ...
            >
                ...
                <DialogContentText id="alert-dialog-slide-description">
                  <div style={{display: "flex", flexDirection: "column", color: "black", textAlign: "center"}}>
                    ...
                    <a style={{textDecoration: "none"}} target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1ca2-CwJA19s8AIClKO-gbGWlA9SroAF1/view?usp=sharing">Resume</a>
